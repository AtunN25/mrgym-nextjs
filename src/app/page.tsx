                            ...
                            <div className='text-black w-2/3  pt-14 '>
                                ...
                                <div className=' flex justify-center items-center'>
                                    <form className="space-y-2    md:space-y-6 pt-12 px-10 " action="#" onSubmit={handleSubmit}>
                                        ...
                                        <button type="submit" className=" w-full flex justify-center text-white bg-slate-800 border hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800  ">Sign in</button>
